...
{
   timestamper =
       new aggregator::Timestamper<base::samples::LaserScan>
...
void Task::updateHook()
{
	...
	timestamper->pushReference(ts);


    while(timestamper->fetchItem(reading,ts,now)) {
	reading.time = ts;
